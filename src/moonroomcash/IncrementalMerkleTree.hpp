...
#include "Moonroomcash.h"

namespace libmoonroomcash {
...
} // end namespace `libmoonroomcash`

typedef libmoonroomcash::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libmoonroomcash::SHA256Compress> ZCIncrementalMerkleTree;
typedef libmoonroomcash::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libmoonroomcash::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libmoonroomcash::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libmoonroomcash::SHA256Compress> ZCIncrementalWitness;
typedef libmoonroomcash::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libmoonroomcash::SHA256Compress> ZCTestingIncrementalWitness;
