...
# contains all of the packages required to build this version of Moonroomcash.
#
# This script assumes you've just built Moonroomcash, and that as a result of that
