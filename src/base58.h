...
class CZCPaymentAddress : public CZCEncoding<libmoonroomcash::PaymentAddress, CChainParams::ZCPAYMENT_ADDRRESS, libmoonroomcash::SerializedPaymentAddressSize> {
protected:
...
public:
    ...
    CZCPaymentAddress(const libmoonroomcash::PaymentAddress& addr) { Set(addr); }
};

class CZCViewingKey : public CZCEncoding<libmoonroomcash::ViewingKey, CChainParams::ZCVIEWING_KEY, libmoonroomcash::SerializedViewingKeySize> {
protected:
...
public:
    ...
    CZCViewingKey(const libmoonroomcash::ViewingKey& vk) { Set(vk); }
};

class CZCSpendingKey : public CZCEncoding<libmoonroomcash::SpendingKey, CChainParams::ZCSPENDING_KEY, libmoonroomcash::SerializedSpendingKeySize> {
protected:
...
public:
    ...
    CZCSpendingKey(const libmoonroomcash::SpendingKey& addr) { Set(addr); }
};
