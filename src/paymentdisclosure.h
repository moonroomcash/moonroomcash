...
#ifndef MRCCASH_PAYMENTDISCLOSURE_H
#define MRCCASH_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // moonroomcash/NoteEncryption.cpp
    ...
    PaymentDisclosureInfo(uint8_t v, uint256 esk, uint256 key, libmoonroomcash::PaymentAddress zaddr) : version(v), esk(esk), joinSplitPrivKey(key), zaddr(zaddr) { }
...
struct PaymentDisclosurePayload {
    ...
    libmoonroomcash::PaymentAddress zaddr; // moonroomcash/Address.hpp
...
#endif // MRCCASH_PAYMENTDISCLOSURE_H
