...
template<>
void expect_deser_same(const libmoonroomcash::MerklePath& expected)
{
...
TEST(merkletree, emptyroots) {
    ...
    libmoonroomcash::EmptyMerkleRoots<64, libmoonroomcash::SHA256Compress> emptyroots;
