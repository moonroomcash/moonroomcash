...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your moonroomcash.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("moonroomcash-metrics-screen");
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << _("Thank you for running a Moonroomcash node!") << std::endl;
