...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Moonroomcash moonroomcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  moonroomcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded moonroomcash transaction") + "\n" +
              "  moonroomcash-tx [options] -create [commands]   " + _("Create hex-encoded moonroomcash transaction") + "\n" +
              "\n";
