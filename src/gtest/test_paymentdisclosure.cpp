...
/*
    To run tests:
    ./moonroomcash-gtest --gtest_filter="paymentdisclosure.*"
...
TEST(paymentdisclosure, mainnet) {
    ...
    for (int i=0; i<NUM_TRIES; i++) {
        ...
        info.zaddr = libmoonroomcash::SpendingKey::random().address();
        ...
        info2.zaddr = libmoonroomcash::SpendingKey::random().address();        
