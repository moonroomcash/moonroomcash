/*
See the Moonroomcash protocol specification for more information.
https://github.com/moonroomcash/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libmoonroomcash::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libmoonroomcash::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libmoonroomcash::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
