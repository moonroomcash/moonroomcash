...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total Moonroomcash balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"moonroomcashaddress\"\n"
            "\nReturn information about the given Moonroomcash address.\n"
            "\nArguments:\n"
            "1. \"moonroomcashaddress\"     (string, required) The Moonroomcash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"moonroomcashaddress\",   (string) The Moonroomcash address validated\n"
...
UniValue z_validateaddress(const UniValue& params, bool fHelp)
{
    ...
    try {
        ...
        libmoonroomcash::PaymentAddress addr = address.Get();
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are Moonroomcash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) Moonroomcash address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"moonroomcashaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"moonroomcashaddress\"    (string, required) The Moonroomcash address to use for the signature.\n"
