...
bool CWalletDB::WriteCryptedZKey(const libmoonroomcash::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libmoonroomcash::PaymentAddress& addr, const libmoonroomcash::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteViewingKey(const libmoonroomcash::ViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseViewingKey(const libmoonroomcash::ViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libmoonroomcash::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libmoonroomcash::ReceivingKey rk(rkValue);
...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("moonroomcash-wallet");
