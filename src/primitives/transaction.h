...
public:
    ...
    JSDescription(ZCJoinSplit& params,
            ...
            const uint256& rt,
            const boost::array<libmoonroomcash::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libmoonroomcash::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
